...
import { PawPrint, ArrowLeft, Mail, Phone, MapPin } from 'lucide-react';
        ...
        <div className="space-y-10 text-sm leading-relaxed text-gray-600">
          ...
          <section>
            ...
            <ul className="space-y-2 list-disc list-inside">
              <li><strong className="text-gray-900">&quot;서비스&quot;</strong>란 회사가 제공하는 반려동물 건강 기록, AI 식품 분석, 건강 달력, 커뮤니티 등 플랫폼 기능 일체를 말합니다.</li>
              <li><strong className="text-gray-900">&quot;회원&quot;</strong>이란 본 약관에 동의하고 서비스에 가입하여 이용하는 자를 말합니다.</li>
              <li><strong className="text-gray-900">&quot;유료 서비스&quot;</strong>란 회사가 유료로 제공하는 구독 플랜 및 추가 기능을 말합니다.</li>
              <li><strong className="text-gray-900">&quot;콘텐츠&quot;</strong>란 회원이 서비스 내에 등록·업로드한 텍스트, 이미지, 반려동물 정보 등 모든 자료를 말합니다.</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ol className="space-y-2 list-decimal list-inside">
              ...
              <li>회사는 관련 법령을 위반하지 않는 범위에서 약관을 개정할 수 있으며, 중요 사항 변경 시 최소 <strong className="text-gray-900">7일 전</strong> 공지합니다.</li>
              <li>회원이 변경된 약관에 동의하지 않을 경우 서비스 이용을 중단하고 탈퇴할 수 있습니다. 공지 후 계속 이용 시 변경 약관에 동의한 것으로 간주합니다.</li>
            </ol>
          </section>

          <section>
            <h2 className="text-lg font-semibold text-gray-900 mb-3">제4조 (회원 가입)</h2>
            <ol className="space-y-2 list-decimal list-inside">
              <li>서비스는 만 <strong className="text-gray-900">14세 이상</strong>이면 누구나 가입할 수 있습니다.</li>
          ...
          <section>
            <h2 className="text-lg font-semibold text-gray-900 mb-3">제5조 (서비스 이용)</h2>
            <ol className="space-y-2 list-decimal list-inside">
              <li>서비스는 <strong className="text-gray-900">연중무휴 24시간</strong> 제공함을 원칙으로 합니다. 단, 시스템 점검·장애·천재지변 등의 사유로 일시 중단될 수 있으며 사전 공지합니다.</li>
          ...
          <section>
            ...
            <ol className="space-y-2 list-decimal list-inside">
              ...
              <li>환불은 별도의 <Link href="/refund" className="text-orange-500 hover:underline">환불 정책</Link>에 따릅니다.</li>
            </ol>
          </section>

          <section>
            <h2 className="text-lg font-semibold text-gray-900 mb-3">제8조 (콘텐츠 및 지식재산권)</h2>
            <ol className="space-y-2 list-decimal list-inside">
          ...
          <section>
            <h2 className="text-lg font-semibold text-gray-900 mb-3">제9조 (AI 분석 서비스 면책)</h2>
            <ol className="space-y-2 list-decimal list-inside">
              <li>펫헬스의 AI 건강 분석 및 식품 분석 결과는 <strong className="text-gray-900">참고용 정보</strong>이며, 수의학적 진단을 대체하지 않습니다.</li>
          ...
          <section>
            <h2 className="text-lg font-semibold text-gray-900 mb-3">제10조 (서비스 이용 제한 및 계약 해지)</h2>
            <ol className="space-y-2 list-decimal list-inside">
          ...
          <section>
            <h2 className="text-lg font-semibold text-gray-900 mb-3">제11조 (책임 제한)</h2>
            <ol className="space-y-2 list-decimal list-inside">
          ...
          <section>
            ...
            <ol className="space-y-2 list-decimal list-inside">
              ...
              <li>분쟁 발생 시 먼저 이메일(<a href="mailto:help@petcare.pe.kr" className="text-orange-500 hover:underline">help@petcare.pe.kr</a>)을 통해 협의를 시도합니다.</li>
              <li>협의가 이루어지지 않을 경우 회사 소재지를 관할하는 법원을 전속 관할 법원으로 합니다.</li>
            </ol>
          </section>

          <section>
            <h2 className="text-lg font-semibold text-gray-900 mb-3">제13조 (문의)</h2>
            <ul className="space-y-1">
              <li>상호명: 코어넥스트 | 대표자: 조민성</li>
              <li>사업장 소재지: 경기도 시흥시 마유로423번길 20-7</li>
              <li>사업자등록번호: 297-66-00726 | 통신판매업신고: 신청 중</li>
              <li>이메일: <a href="mailto:help@petcare.pe.kr" className="text-orange-500 hover:underline">help@petcare.pe.kr</a></li>
            </ul>
          </section>
