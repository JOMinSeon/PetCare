      ...
      <section id="pricing" className="py-20 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            {/* Basic Plan */}
            <div className="flex flex-col p-8 rounded-xl border border-slate-200 bg-slate-50">
              <h3 className="text-2xl font-bold text-slate-900 mb-2">기본</h3>
              <p className="text-slate-600 mb-6">한 마리 반려동물</p>
              <p className="text-4xl font-bold text-slate-900 mb-6">무료</p>
              <ul className="space-y-3 mb-8 flex-1">
                <li className="flex gap-3 items-start">
                  <CheckCircle size={20} className="text-emerald-500 flex-shrink-0 mt-0.5" />
                  <span className="text-slate-700">기본 건강 기록</span>
                </li>
                <li className="flex gap-3 items-start">
                  <CheckCircle size={20} className="text-emerald-500 flex-shrink-0 mt-0.5" />
                  <span className="text-slate-700">주간 리포트</span>
                </li>
              </ul>
              <Link
                href="/auth/signup"
                className="w-full block py-3 px-4 border-2 border-slate-300 text-slate-900 rounded-lg font-semibold text-center hover:border-slate-400 transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
              >
                시작하기
              </Link>
            </div>
            ...
            {/* Pro Plan */}
            <div className="flex flex-col p-8 rounded-xl border-2 border-blue-600 bg-gradient-to-br from-blue-50 to-white relative">
              <div className="absolute top-0 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
                <span className="bg-blue-600 text-white px-4 py-1 rounded-full text-sm font-semibold">인기</span>
              </div>
              <h3 className="text-2xl font-bold text-slate-900 mb-2">전문가</h3>
              <p className="text-slate-600 mb-6">3마리 반려동물</p>
              <p className="text-4xl font-bold text-slate-900 mb-2">
                9,900원 <span className="text-lg text-slate-600">/월</span>
              </p>
              <p className="text-slate-600 mb-6">요금제에 포함됨</p>
              <ul className="space-y-3 mb-8 flex-1">
                <li className="flex gap-3 items-start">
                  <CheckCircle size={20} className="text-blue-600 flex-shrink-0 mt-0.5" />
                  <span className="text-slate-700">완전한 건강 분석</span>
                </li>
                <li className="flex gap-3 items-start">
                  <CheckCircle size={20} className="text-blue-600 flex-shrink-0 mt-0.5" />
                  <span className="text-slate-700">AI 기반 예측</span>
                </li>
                <li className="flex gap-3 items-start">
                  <CheckCircle size={20} className="text-blue-600 flex-shrink-0 mt-0.5" />
                  <span className="text-slate-700">월간 상담 1회</span>
                </li>
              </ul>
              <Link
                href="/auth/signup"
                className="w-full block py-3 px-4 bg-blue-600 text-white rounded-lg font-semibold text-center hover:bg-blue-700 transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
              >
                지금 시작
              </Link>
            </div>
            ...
            {/* Premium Plan */}
            <div className="flex flex-col p-8 rounded-xl border border-slate-200 bg-slate-50">
              <h3 className="text-2xl font-bold text-slate-900 mb-2">프리미엄</h3>
              <p className="text-slate-600 mb-6">무제한</p>
              <p className="text-4xl font-bold text-slate-900 mb-2">
                29,900원 <span className="text-lg text-slate-600">/월</span>
              </p>
              <p className="text-slate-600 mb-6">요금제에 포함됨</p>
              <ul className="space-y-3 mb-8 flex-1">
                <li className="flex gap-3 items-start">
                  <CheckCircle size={20} className="text-emerald-500 flex-shrink-0 mt-0.5" />
                  <span className="text-slate-700">무제한 반려동물</span>
                </li>
                <li className="flex gap-3 items-start">
                  <CheckCircle size={20} className="text-emerald-500 flex-shrink-0 mt-0.5" />
                  <span className="text-slate-700">무제한 상담</span>
                </li>
                <li className="flex gap-3 items-start">
                  <CheckCircle size={20} className="text-emerald-500 flex-shrink-0 mt-0.5" />
                  <span className="text-slate-700">우선 지원</span>
                </li>
              </ul>
              <Link
                href="/auth/signup"
